...
setup(
    ...
    entry_points={
        'console_scripts': [
                ...
                'example_new = nav2_simple_commander.example_new:main',
                'example_goal = nav2_simple_commander.example_goal:main',
                'final_destination = nav2_simple_commander.final_destination:main',
                'shortest_path = nav2_simple_commander.shortest_path:main',
        ],
    },
)
