...
def generate_launch_description():
   ...
   #python_aws_dir = get_package_share_directory('aws-robomaker-small-warehouse-world')
   ...
   world = os.path.join(
    ...
    map_yaml_file = os.path.join(warehouse_dir, 'maps', '002', 'map.yaml')
    world = os.path.join(python_commander_dir, 'warehouse.world')
    #world = os.path.join(python_aws_dir,'no_roof_small_warehouse.world')
