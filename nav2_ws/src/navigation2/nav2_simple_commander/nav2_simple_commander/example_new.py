...
def main():
    ...
    goal_pose.pose.position.x = 24.007821337018697
    goal_pose.pose.position.y = -56.10679437499999
    goal_pose.pose.orientation.w = 1.0
    # goal_pose = PoseStamped()
    # goal_pose.header.frame_id = 'map'
    # goal_pose.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose.pose.position.x = 6.0
    # goal_pose.pose.position.y = -0.35
    # goal_pose.pose.orientation.w = 1.0
    ...
    # next_goal_pose.header.stamp = navigator.get_clock().now().to_msg()
    # next_goal_pose.pose.position.x = 3.45
    # next_goal_pose.pose.position.y = 2.15
    # next_goal_pose.pose.orientation.w = 1.0

    # navigator.getAndTrackRoute(goal_pose, next_goal_pose)
    ...
    while not navigator.isTaskComplete(trackingRoute=isTrackingRoute):
        ...
        if feedback is not None:
            ...
            # Assuming you have a publisher defined somewhere
