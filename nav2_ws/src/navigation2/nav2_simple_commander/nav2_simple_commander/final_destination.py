...
def main():
    ...
    smoothed_path_publisher = navigator.create_publisher(Path, 'smoothed_pa', 10)
    ...
    goal_pose.pose.position.x =  37.310601098196855
    goal_pose.pose.position.y =  -52.50548533691405
                ...
                if feedback.rerouted:
                    ...
                    if pathh is not None:
                        ...
                        if smoothed_path is not None:  # Check if the smoothed path is not None
                            ...
                            smoothed_path_publisher.publish(smoothed_path)
                        else:
